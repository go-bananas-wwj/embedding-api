...
FIELD_DOCS = {
    ...
    "month": "影像月份或日期。支持 `YYYY-MM`、`YYYYMM` 或部分接口的 `YYYYMMDD`；日级表示精确日期，月级表示在该月内选择代表影像。",
    "date": "影像日期或月份。支持 `YYYY-MM`、`YYYYMM` 或 `YYYYMMDD`；`YYYYMMDD` 精确命中，月级请求会选择同月内距离 15 日最近的一景。",
    ...
    "annotations": "GeoJSON 标注包。坐标必须是 WGS84，经纬度顺序为 `[lon, lat]`。",
